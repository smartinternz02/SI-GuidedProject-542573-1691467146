...
app = Flask(__name__)
app.secret_key = 'a'
conn = ibm_db.connect("DATABASE=bludb; HOSTNAME=1bbf73c5-d84a-4bb0-85b9-ab1a4348f4a4.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud; PORT=32286; UID=trd17134; PASSWORD=AVovDmEgKjAUBaQf; SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt", "", "")
...
def signup():
    ...
    if request.method == 'POST':
        ...
        link = 'https://praveenuniversity.ac.in/portal'
        print(password)
        ...
        if account:
            ...
            payload = {
                ...
                "content": [
                    {
                        "type": "text/plain",
                        "value": "Dear {} ,  \n Welcome to Praveen University, Here there the details to Login Into your student portal link : {} \n YOUR Username : {} \n  PASSWORD : {}  \n Thank you \n Sincerely\n Office of  Admissions\n Praveen Institute of Technology \n E-Mail: admission@praveenuniversity.ac.in ; Website: www.praveenuniversity.ac.in" .format( name,link, username, password)
                    }
                ]
            }
            headers = {
...
def marksassign(stdname):
    ...
    COS_API_KEY_ID = "wrp6S_O8coKLhxgS1hCIZCP3be6R9ISwzBdriY09tO2K"
    COS_INSTANCE_CRN = "crn:v1:bluemix:public:cloud-object-storage:global:a/2112efd7eed447ae8d40b2bba4763b94:92c3f9fc-f219-465b-aa81-06a1798cd2eb::"
    cos = ibm_boto3.client("s3",
                        ibm_api_key_id=COS_API_KEY_ID,
                        ibm_service_instance_id=COS_INSTANCE_CRN,
                        config=Config(signature_version="oauth"),
                        endpoint_url=COS_ENDPOINT)
    output = cos.list_objects(Bucket="praveen-assignment")
    output
    l=[]
